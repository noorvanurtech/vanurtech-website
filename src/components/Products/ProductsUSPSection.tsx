...
import { Package, CheckCircle2, Sparkles, Zap } from "lucide-react";

const uspItems = [
  "Ready-to-deploy with zero setup hassle",
  "Fully customizable to your business needs",
  "Cloud-based with 99.9% uptime guarantee",
  "Dedicated support & onboarding team",
];

export default function ProductsUSPSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-3/5 text-left">
            ...
            >
              Our software products are designed with one goal — to make your business faster, smarter, and more profitable from day one.
            </motion.p>
                ...
                <div className="flex gap-4 items-start relative z-10">
                  ...
                  <div>
                    <p className="text-white text-lg md:text-xl lg:text-2xl font-semibold leading-tight">
                      &quot;We don&apos;t just sell software — we deliver{" "}
          ...
          <div className="w-full lg:w-2/5 relative">
            ...
            >
              ...
              {[Sparkles, Zap, Package, Sparkles].map((Icon, idx) => (
                <motion.div
                  key={idx}
                  className="absolute"
                  animate={{ rotate: 360 }}
