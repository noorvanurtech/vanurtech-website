  ...
  const points = [
    {
      ...
      desc: "A decade of mastery in engineering robust CRM & ERP applications.",
      icon: Trophy,
    ...
    },
    {
      ...
      desc: "Proven track record of successful and robust launches globally.",
      icon: Star,
      color: "text-pink-400",
      bg: "bg-pink-500/10",
    ...
    },
    {
      ...
      desc: "Built from the ground up to rank higher and convert visitors.",
      icon: Flame,
    ...
    },
    {
      ...
      desc: "No templates. Every line of code is written tailored to your logic.",
      icon: Coffee,
    ...
    },
    {
      ...
      desc: "Continuous technical maintenance and highly reliable partnership.",
      icon: Users,
      color: "text-blue-400",
      bg: "bg-blue-500/10",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 sm:mb-14">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            ...
            >
              We focus on precision, scalability, and solving real-world business problems through intelligent CRM & ERP engineering.
            </motion.p>
          </div>
        </div>
