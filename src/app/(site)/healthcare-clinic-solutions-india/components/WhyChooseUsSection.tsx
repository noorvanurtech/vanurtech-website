...
const reasons = [
  {
    ...
    description: "Systems designed with clinicians to ensure workflow accuracy and patient safety.",
  ...
  },
  {
    label: "SECURITY",
    title: "Data Privacy",
    description: "Multi-layer encryption and strict compliance to keep patient records 100% secure.",
  ...
  },
  {
    ...
    description: "Reduce patient wait times and administrative overhead by up to 40%.",
  ...
  },
  {
    ...
    description: "24/7 technical support and on-boarding for doctors and administrative staff.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-violet-500/20 bg-violet-500/5 backdrop-blur-md mb-6">
            ...
            <span className="text-violet-300 text-xs sm:text-sm font-medium tracking-wide">The Care Advantage</span>
          </div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 tracking-tight leading-tight">
            Why Healthcare Providers <span className="text-transparent bg-clip-text bg-linear-to-r from-violet-400 via-indigo-500 to-violet-600">Choose Us</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto font-light">
            We build the digital backbone for modern hospitals and multi-specialty clinics in India.
          </p>
        </motion.div>
