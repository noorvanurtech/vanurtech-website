              ...
              <ul className="space-y-3 sm:space-y-5">
                {comparisons.map((item, idx) => (
                  <motion.li
                    ...
                    viewport={{ once: true }}
                    className="flex items-start gap-3 text-gray-400 text-sm sm:text-base group/item transition-colors hover:text-gray-300"
                  >
                    <span className="mt-2 w-2 h-2 rounded-full bg-red-500/30 shrink-0 group-hover/item:scale-125 transition-transform" />
                    {item.problem}
                  </motion.li>
                ))}
              </ul>
              ...
              >
                ...
                <ul className="space-y-3 sm:space-y-5">
                  {comparisons.map((item, idx) => (
                    ...
                    >
                      <div className="p-1.5 sm:p-2 rounded-xl bg-purple-500/10 border border-purple-500/20 group-hover/item:bg-purple-500/30 group-hover/item:scale-110 group-hover/item:border-purple-400 transition-all duration-300 shrink-0">
