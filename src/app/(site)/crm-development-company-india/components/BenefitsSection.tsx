        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-white leading-[1.1] tracking-tight">
              How Our CRMs <br className="hidden md:block" />
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-10 max-w-xl">
              We don't just build CRMs; we build intelligent business tools that are engineered to deliver measurable growth, engage your audience, and secure long-term success.
            </p>
