...
const reasons = [
  {
    ...
    description: "Our solutions grow with your business, ensuring you only pay for what you need.",
  ...
  },
  {
    ...
    description: "Deep understanding of the Indian market, local compliance, and SME challenges.",
  ...
  },
  {
    ...
    description: "Over 50+ SMBs trust us to manage their digital transformation and automation.",
  ...
  },
  {
    ...
    description: "Continuous technical partnership and priority support for all our business clients.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-violet-500/20 bg-violet-500/5 backdrop-blur-md mb-6">
            ...
            <span className="text-violet-300 text-xs sm:text-sm font-medium tracking-wide">The SMB Advantage</span>
          </div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 tracking-tight leading-tight">
            Why Businesses <span className="text-transparent bg-clip-text bg-linear-to-r from-violet-400 via-indigo-500 to-violet-600">Choose Us</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto font-light">
            We've spent years perfecting our digital transformation framework specifically for small and medium enterprises.
          </p>
        </motion.div>
