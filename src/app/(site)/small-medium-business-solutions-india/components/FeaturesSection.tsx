...
const features = [
  {
    ...
    description: "Centralized platforms to manage inventory, payroll, and operations tailored to your business size.",
    icon: <LayoutDashboard className="w-6 h-6" />
  },
  {
    title: "Automated Billing",
    description: "Streamline invoicing and payments with automated localized billing systems for Indian compliance.",
    icon: <Zap className="w-6 h-6" />
  },
  {
    title: "Inventory Tracking",
    description: "Real-time visibility into your stock levels, warehouse management, and supplier coordination.",
    icon: <BarChart3 className="w-6 h-6" />
  },
  {
    title: "Business Automation",
    description: "Replace manual repetitive tasks with smart AI-driven workflows to save time and reduce errors.",
    icon: <Smartphone className="w-6 h-6" />
  },
  {
    title: "Secure Data Storage",
    description: "Enterprise-grade security for your business data with encrypted backups and access controls.",
    icon: <ShieldCheck className="w-6 h-6" />
  },
  {
    title: "Growth Analytics",
    description: "Visual dashboards that show you exactly where your business is growing and where it needs focus.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="text-gray-400 text-base sm:text-lg max-w-3xl mx-auto leading-relaxed px-2 sm:px-0">
            We don't just build software — we engineer powerful business platforms that help you automate operations, track growth, and scale efficiently.
          </p>
        </div>
