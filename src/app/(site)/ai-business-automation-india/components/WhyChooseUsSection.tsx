  ...
  const points = [
    {
      ...
      desc: "A decade of mastery in engineering robust enterprise-grade applications.",
      icon: Trophy,
    ...
    {
      title: "AI + Custom Software Expertise",
      desc: "We don't just build software, we engineer intelligent systems that learn and adapt.",
      icon: Brain,
      color: "text-pink-400",
      bg: "bg-pink-500/10",
    ...
    },
    {
      ...
      desc: "Every AI integration is uniquely tailored to resolve your specific operational bottlenecks.",
      icon: Target,
    ...
    },
    {
      ...
      desc: "A proven track record of boosting conversion and cutting manual effort globally.",
      icon: LineChart,
    ...
    },
    {
      ...
      desc: "Continuous technical maintenance, monitoring, and highly reliable partnership.",
      icon: Headset,
      color: "text-blue-400",
      bg: "bg-blue-500/10",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        <div className="mb-8 sm:mb-14 text-center lg:text-left">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 sm:gap-6">
            ...
            >
              We focus on precision, scalability, and solving real-world business problems through intelligent automation engineering.
            </motion.p>
          </div>
        </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-white text-base font-semibold leading-snug">
                Let&apos;s build an intelligent system that works for you 24/7.
              </p>
            </div>
