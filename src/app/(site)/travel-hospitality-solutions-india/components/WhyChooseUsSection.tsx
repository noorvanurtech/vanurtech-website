...
const reasons = [
  {
    ...
    description: "Deep understanding of international travel standards and booking workflows.",
  ...
  },
  {
    ...
    description: "Automate booking confirmations and customer communication to save 50% time.",
  ...
  },
  {
    ...
    description: "Cloud-native architecture that supports unlimited bookings and user traffic.",
  ...
  },
  {
    ...
    description: "Real-time system monitoring to ensure 99.9% uptime for your booking portals.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-violet-500/20 bg-violet-500/5 backdrop-blur-md mb-6">
            ...
            <span className="text-violet-300 text-xs sm:text-sm font-medium tracking-wide">The Global Advantage</span>
          </div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 tracking-tight leading-tight">
            Why Travel Enterprises <span className="text-transparent bg-clip-text bg-linear-to-r from-violet-400 via-indigo-500 to-violet-600">Choose Us</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto font-light">
            We provide the digital backbone for modern travel agencies and hospitality brands worldwide.
          </p>
        </motion.div>
