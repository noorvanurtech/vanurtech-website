...
const features = [
  {
    ...
    description: "Custom B2B and B2C booking platforms for flights, hotels, and holiday packages.",
    icon: <Globe className="w-6 h-6" />
  },
  {
    title: "Itinerary Planner",
    description: "AI-powered dynamic itinerary generation and management tools for travel agents.",
    icon: <Map className="w-6 h-6" />
  },
  {
    title: "Hospitality ERP",
    description: "End-to-end management software for hotels, resorts, and vacation rentals.",
    icon: <Hotel className="w-6 h-6" />
  },
  {
    title: "Reservation System",
    description: "Real-time availability tracking and automated reservation confirmation systems.",
    icon: <Calendar className="w-6 h-6" />
  },
  {
    title: "Payment Integration",
    description: "Secure multi-currency payment gateways and automated invoice generation.",
    icon: <CreditCard className="w-6 h-6" />
  },
  {
    title: "Customer App",
    description: "Branded mobile applications for travelers to manage bookings and itineraries.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="text-gray-400 text-base sm:text-lg max-w-3xl mx-auto leading-relaxed px-2 sm:px-0">
            Our hospitality management platform provides the tools you need to automate bookings and deliver exceptional travel experiences.
          </p>
        </div>
