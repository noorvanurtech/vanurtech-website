...
import { Lightbulb, TrendingUp, Search, UserCheck, ShieldCheck, ChevronRight, Sparkles, Heart, Eye, Target } from "lucide-react";

const benefits = [
  { title: "Boost Brand Recognition", icon: <Eye className="w-6 h-6" /> },
  { title: "Create Emotional Connections", icon: <Heart className="w-6 h-6" /> },
  { title: "Target the Right Audience", icon: <Target className="w-6 h-6" /> },
  { title: "Establish Instant Authority", icon: <ShieldCheck className="w-6 h-6" /> },
  { title: "Increase Perceived Value", icon: <TrendingUp className="w-6 h-6" /> }
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-white leading-[1.1] tracking-tight">
              Why Visual Design <br className="hidden md:block" />
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-10 max-w-xl">
              Superior design is your silent salesperson. We blend psychology with art to create visuals that not only look incredible but strategically drive your business goals forward.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-6 border-t border-purple-500/10">
              ...
              <div className="text-sm">
                <p className="text-white font-semibold text-base">Exceptional Design Quality</p>
                <p className="text-gray-400">Trusted by global brands for creative excellence</p>
              </div>
            </div>
          </motion.div>
              ...
              {benefits.map((benefit, idx) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between p-5 sm:p-6 rounded-4xl border border-purple-500/10 bg-white/2 hover:bg-white/5 backdrop-blur-xl group-hover:border-purple-500/30 transition-all duration-500 relative overflow-hidden">
                    ...
                    >
                      <motion.div
                        animate={{ x: [0, 4, 0], color: ['#6b7280', '#d8b4fe', '#6b7280'] }}
                        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: idx * 0.4 }}
                      >
