  ...
  const points = [
    {
      ...
      desc: "Years of experience crafting premium visuals for global market leaders.",
      icon: Palette,
    ...
    {
      title: "500+ Brands Transformed",
      desc: "A portfolio of success across diverse industries and digital domains.",
      icon: Star,
      color: "text-pink-400",
      bg: "bg-pink-500/10",
    ...
    },
    {
      ...
      desc: "Every design is optimized to catch eyes and drive user actions.",
      icon: Flame,
    ...
    },
    {
      ...
      desc: "100% custom, original designs tailored exclusively for your brand.",
      icon: Coffee,
    ...
    {
      title: "Direct Creative Access",
      desc: "Collaborate directly with senior designers for seamless results.",
      icon: Users,
      color: "text-blue-400",
      bg: "bg-blue-500/10",
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="mb-14">
          ...
          >
            ...
            <span className="text-purple-300 text-sm font-medium tracking-wide">Why Work With Us</span>
          </motion.div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            ...
            >
              Excellence in Every <br className="hidden lg:block"/>
              <span className="text-transparent bg-clip-text bg-linear-to-r from-purple-400 to-pink-500">Visual Interaction</span>
            </motion.h2>
            ...
            >
              We focus on aesthetic precision and strategic impact, ensuring your brand stands out in an overcrowded digital landscape.
            </motion.p>
          </div>
        </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-white text-base font-semibold leading-snug">
                Let&apos;s build a visual identity that defines your business success.
              </p>
            </div>
