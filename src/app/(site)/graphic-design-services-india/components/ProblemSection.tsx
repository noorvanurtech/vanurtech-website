...
export function ProblemSection() {
  const comparisons = [
    {
      problem: "Generic & forgettable brand identity",
      solution: "Iconic, Unique & Brand-Focused Logos",
    },
    {
      problem: "Inconsistent design across platforms",
      solution: "Unified Multi-Channel Design Strategy",
    },
    {
      problem: "Poor visual communication of value",
      solution: "High-Impact Graphics that Sell Vision",
    },
    {
      problem: "Outdated aesthetics that repel leads",
      solution: "Modern, Premium & Professional Visuals",
    },
  ];
        ...
        <div>
          <div className="text-center mb-10 sm:mb-12">
            ...
            <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight text-white tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-linear-to-r from-purple-400 via-pink-500 to-purple-600">Unforgettable</span>
            </h3>
            <p className="text-gray-400 text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed">
              Design is more than just looks. It's how you communicate your brand's authority and build instant trust with your audience.
            </p>
          </div>
