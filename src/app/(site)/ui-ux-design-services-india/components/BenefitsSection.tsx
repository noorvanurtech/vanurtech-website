...
const benefits = [
  ...
  { title: "Enhanced User Loyalty", icon: <Lightbulb className="w-6 h-6" /> },
  { title: "Reduced Support Costs", icon: <Search className="w-6 h-6" /> },
  { title: "Data-Driven Decisions", icon: <UserCheck className="w-6 h-6" /> },
  { title: "Optimized User Satisfaction", icon: <ShieldCheck className="w-6 h-6" /> }
];
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-6 border-t border-purple-500/10">
              ...
              <div className="text-sm">
                <p className="text-white font-semibold text-base">Elite Design Partnership</p>
                <p className="text-gray-400">Rated 5/5 for user retention</p>
              </div>
            </div>
          </motion.div>
