...
export function ProblemSection({ onConsultClick }: { onConsultClick?: () => void }) {
  const comparisons = [
    {
      problem: "Confusing navigation & high friction",
      solution: "Seamless, Intuitive User Flows",
    },
    {
      problem: "Outdated visuals & inconsistent branding",
      solution: "Modern, High-End Visual Identity",
    },
    {
      problem: "Accessibility issues & poor mobile UX",
      solution: "Inclusive & Responsive Design Systems",
    },
    {
      problem: "Low engagement & high drop-off rates",
        ...
        <div>
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight text-white tracking-tight">
              ...
              From <span className="text-gray-500 underline decoration-red-500/30 underline-offset-8">Confusing</span> to{" "}
              <span className="text-transparent bg-clip-text bg-linear-to-r from-purple-400 via-pink-500 to-purple-600">Legendary</span>
            </h3>
            <p className="text-gray-400 text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed">
              Don't settle for a design that just looks pretty. We build intuitive interfaces that drive engagement and capture value.
            </p>
          </div>
