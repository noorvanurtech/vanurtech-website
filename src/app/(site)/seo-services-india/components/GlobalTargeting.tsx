  ...
  return (
    <section className="relative w-full bg-[#0A0014] overflow-hidden flex flex-col items-center pt-24 pb-10 font-sans border-t border-purple-900/20">
      ...
      <div className="relative z-20 flex flex-col items-center text-center px-4 max-w-4xl mx-auto mb-16">
        ...
        >
          Boosting Search Visibility <br className="hidden md:block" />
        ...
        <motion.p 
          ...
          className="text-zinc-400 text-lg sm:text-lg max-w-3xl mx-auto leading-relaxed"
        >
          Our SEO strategies are custom-tailored for international markets, helping businesses in India, USA, UK, and Canada dominate local and global search results.
        </motion.p>
      </div>

      {/* Futuristic Dotted World Map Network Area */}
      <div className="relative w-full max-w-[1000px] h-[500px] sm:h-[600px] mx-auto opacity-90 border-t border-white/2">
