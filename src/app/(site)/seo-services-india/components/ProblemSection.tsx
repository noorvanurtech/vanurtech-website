...
export function ProblemSection({ onConsultClick }: { onConsultClick?: () => void }) {
  const comparisons = [
    {
      problem: "Hidden on page 2 (or worse) of Google",
      solution: "Dominate First-Page Rankings & Visibility",
    },
    {
      problem: "Irrelevant traffic that doesn't convert",
      solution: "Targeted, High-Intent Keyword Strategy",
    },
    {
      problem: "Technical errors hurting your authority",
      solution: "Pristine Technical SEO & Site Health",
    },
    {
      problem: "Losing customers to outranked competitors",
      solution: "Outpace Rivals with Data-Driven Growth",
    },
  ];
        ...
        <div>
          <div className="text-center mb-10 sm:mb-12">
            ...
            <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight text-white tracking-tight">
              ...
              From <span className="text-gray-500 underline decoration-red-500/30 underline-offset-2">Invisible</span> to{" "}
            ...
            <p className="text-zinc-400 text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed">
              If your business isn't on the first page, it doesn't exist for 90% of searchers. We fix that with advanced SEO.
            </p>
          </div>
              ...
              <ul className="space-y-4 sm:space-y-6">
                {comparisons.map((item, idx) => (
                  <motion.li
                    ...
                    viewport={{ once: true }}
                    className="flex items-start gap-3 sm:gap-4 text-zinc-400 text-base sm:text-lg group/item transition-colors hover:text-gray-300"
                  >
