...
export default function WhatsAppChatbotContent() {
      ...
      <section className="py-16 relative z-10 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-zinc-400 text-sm md:text-base">
          <p>
            ...
            <Link
              href="/products/solar-management-software"
              className="text-[#a78bfa] hover:text-white transition-colors duration-300 underline underline-offset-4"
            >
              Solar Management Software
            </Link>
            ,{" "}
            <Link
              href="/products/finance-management-software"
              className="text-[#a78bfa] hover:text-white transition-colors duration-300 underline underline-offset-4"
            >
