...
const comparisons = [
  {
    problem: "Customers message at night and get no response",
    solution: "24/7 AI Replies — Never Miss a Message Again",
  },
  {
    problem: "Sales team wastes time on repetitive FAQs",
    solution: "Instant Automated Answers to Common Questions",
  },
  {
    problem: "Leads slip through the cracks without follow-up",
    solution: "Automatic Lead Capture & Qualification",
  },
  {
    problem: "No way to send bulk updates or promotions",
    solution: "Broadcast Campaigns to Thousands in One Click",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight text-white tracking-tight">
            From <span className="text-gray-500 underline decoration-red-500/30 underline-offset-8">Missed Messages</span> to{" "}
          ...
          <p className="text-gray-400 text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed">
            Stop losing customers to slow response times. Our WhatsApp AI chatbot keeps your business available around the clock.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <div className="absolute -inset-[2px] bg-linear-to-r from-purple-500 via-pink-400 to-purple-500 rounded-[2.6rem] opacity-30 group-hover:opacity-100 blur-[2px] transition-opacity duration-500 animate-pulse" />
            <motion.div
              animate={{ y: [0, -15, 0] }}
            ...
            >
              ...
              <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-pink-500/10 blur-[80px] rounded-full animate-pulse" />
              <h4 className="text-xl sm:text-2xl font-bold text-white mb-5 sm:mb-8 flex items-center gap-3">
