  ...
  return (
    <section className="py-12 sm:py-16 relative overflow-hidden bg-[#0B0011]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-500/20 bg-purple-500/5 backdrop-blur-md mb-4 mx-auto">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white leading-tight">
            See the Chatbot <br className="md:hidden" />
