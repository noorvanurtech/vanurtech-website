      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 mt-3 max-w-xl text-sm sm:text-base">
            A clean, powerful interface to manage invoices, quotations, payments, and GST — all from one screen.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute -inset-px rounded-2xl bg-linear-to-r from-blue-500/30 via-blue-300/20 to-blue-500/30 blur-sm pointer-events-none" />
          <div className="relative rounded-2xl overflow-hidden border border-blue-500/20 shadow-2xl shadow-blue-500/10">
            ...
            <Image
              ...
              alt="Finance Management Software Dashboard"
              width={1200}
              height={675}
