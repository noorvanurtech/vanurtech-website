...
const features = [
  {
    title: "Student ERP",
    description: "End-to-end management from student enrollment and KYC to final certification.",
    icon: <Users className="w-6 h-6" />
  },
  {
    title: "Fee Management",
    description: "Automated fee collection, reminder systems, and integrated payment gateways.",
    icon: <CreditCard className="w-6 h-6" />
  },
  {
    title: "Learning Portals",
    description: "High-performance LMS for online classes, assignments, and study material distribution.",
    icon: <BookOpen className="w-6 h-6" />
  },
  {
    title: "Exam & Results",
    description: "Digital examination management with automated result generation and analytics.",
    icon: <LayoutDashboard className="w-6 h-6" />
  },
  {
    title: "Parent Portal",
    description: "Real-time tracking of student progress, attendance, and fee status for parents.",
    icon: <GraduationCap className="w-6 h-6" />
  },
  {
    title: "Automated Alerts",
    description: "Instant notifications for attendance, exam schedules, and holiday announcements.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="text-gray-400 text-base sm:text-lg max-w-3xl mx-auto leading-relaxed px-2 sm:px-0">
            Our comprehensive institute management software helps schools and colleges automate operations and focus on delivering quality education.
          </p>
        </div>
