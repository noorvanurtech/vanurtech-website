...
import { Sparkles, CheckCircle2, XCircle, ArrowRight, Smartphone } from "lucide-react";

export function ProblemSection({ onConsultClick }: { onConsultClick?: () => void }) {
  const comparisons = [
    {
      problem: "Cluttered UI & confusing navigation",
      solution: "Intuitive, User-Centric Mobile Experience",
    },
    {
      problem: "Slow app performance & frequent crashes",
      solution: "High-Performance native & hybrid apps",
    },
    {
      problem: "Lack of offline functionality & engagement",
      solution: "Feature-Rich architecture with Push Notifications",
    },
    {
      problem: "Poor security & data protection",
      solution: "Enterprise-Grade Security & Scalability",
    },
  ];
        ...
        <div>
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight text-white tracking-tight">
              Elevate Your Business: <br className="md:hidden" />
              From <span className="text-gray-500 underline decoration-red-500/30 underline-offset-8">Standard</span> to{" "}
              <span className="text-transparent bg-clip-text bg-linear-to-r from-purple-400 via-pink-500 to-purple-600">Extraordinary</span>
            </h3>
            <p className="text-gray-400 text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed">
              Don't let a poorly built app hold your business back. We build mobile solutions that engage users and drive consistent growth.
            </p>
          </div>
