...
const benefits = [
  ...
  { title: "Modern Brand Presence", icon: <Lightbulb className="w-6 h-6" /> },
  { title: "App Store Optimization", icon: <Search className="w-6 h-6" /> },
  { title: "Personalized Experience", icon: <UserCheck className="w-6 h-6" /> },
  { title: "Higher Retention Rates", icon: <ShieldCheck className="w-6 h-6" /> }
];
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-5 sm:mb-8 text-white leading-[1.1] tracking-tight">
              How Our Apps <br className="hidden md:block" />
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed mb-6 sm:mb-10 max-w-xl">
              We don't just build apps; we create high-performance mobile tools engineered to deliver measurable business results and keep your users coming back.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-6 border-t border-purple-500/10">
              ...
              <div className="text-sm">
                <p className="text-white font-semibold text-base">Trusted by Global Brands</p>
                <p className="text-gray-400">Rated 5/5 for mobile innovation</p>
              </div>
            </div>
          </motion.div>
